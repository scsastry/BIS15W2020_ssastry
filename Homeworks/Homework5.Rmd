...
##Remember to make the chart (data table) before making the plot.
```{r}
amniota %>%
...
##Nice! Not many people accounted for this.
```{r}
...
#Remember one of these needed to be the unfiltered version showing outliers.
```{r}
amphibio_body_litter %>%
