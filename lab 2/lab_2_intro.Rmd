...
1. What is the association between `R` and `R Studio`?  R is the base program and R studio is the GUI
2. What is the association between `github.com` and `GitHub Desktop`?  Github desktop is the GUI and github.com is the website
3. What is an `object` in R? Container for value
4. Which two `classes` of data do you think will be used most? Numeric and characters
5. What is a `vector` in R?  Stores a dataset
